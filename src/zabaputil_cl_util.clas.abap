...
CLASS zabaputil_cl_util IMPLEMENTATION.
  ...
  METHOD boolean_check_by_data.
        ...
        DATA temp96 TYPE zabaputil_cl_util=>ty_s_bool_cache.
  ...
  METHOD filter_get_multi_by_data.
    ...
    DATA lr_comp LIKE REF TO temp5.
      DATA temp101 TYPE zabaputil_cl_util=>ty_s_filter_multi.
  ...
  METHOD filter_update_tokens.
    FIELD-SYMBOLS <temp102> TYPE zabaputil_cl_util=>ty_s_filter_multi.
DATA lr_filter LIKE REF TO <temp102>.
    DATA ls_token LIKE LINE OF lr_filter->t_token_removed.
      DATA temp103 TYPE zabaputil_cl_util=>ty_s_token.
...
GET REFERENCE OF <temp102> INTO lr_filter.
    ...
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    lt_range = zabaputil_cl_util=>filter_get_range_t_by_token_t( temp6-t_token ).
  ...
  METHOD filter_get_token_range_mapping.
    ...
    DATA temp104 TYPE zabaputil_cl_util=>ty_t_name_value.
  ...
  METHOD filter_get_token_t_by_range_t.
    ...
    DATA lr_row LIKE REF TO temp107.
      ...
      DATA temp108 TYPE zabaputil_cl_util=>ty_s_token.
...
DATA lt_cols TYPE temp2.
  ...
  METHOD json_stringify.
        DATA temp116 TYPE REF TO zabaputil_if_ajson.
        DATA li_ajson LIKE temp116.
        DATA x TYPE REF TO cx_root.
    TRY.

        
        temp116 ?= zabaputil_cl_ajson=>create_empty( ).
...
|x, nsis, objectivec, ocaml, pascal, perl, pgsql, php, plain_text, powershell, praat, prolog, properties, protobuf, python, r, razor, rdoc, rhtml, rst, ruby, rust, sass, scad, scala, scheme, scss, sh, sjs, smarty, snippets, soy_template, space, sql,| &&
  ...
  METHOD url_param_get.
    ...
    DATA temp133 TYPE zabaputil_cl_util=>ty_s_name_value.
...
DATA lt_param TYPE temp3.
    ...
    DATA lr_param LIKE REF TO temp135.
      ...
      DATA temp136 TYPE zabaputil_cl_util=>ty_s_name_value.
  ...
  METHOD url_param_set.
    ...
    DATA lr_params LIKE REF TO temp137.
      DATA temp138 TYPE zabaputil_cl_util=>ty_s_name_value.
    lt_params = url_param_get_tab( url ).
  ...
  METHOD itab_get_by_struc.
    ...
    DATA lr_attri LIKE REF TO temp143.
      FIELD-SYMBOLS <component> TYPE any.
          DATA temp144 TYPE zabaputil_cl_util=>ty_s_name_value.
...
*         e_t_where      = lt_where
  ...
  METHOD app_get_url.
    ...
    DATA temp173 TYPE zabaputil_cl_util=>ty_s_name_value.
