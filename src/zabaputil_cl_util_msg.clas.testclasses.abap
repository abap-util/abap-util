...
CLASS ltcl_unit_test_msg_mapper IMPLEMENTATION.
  ...
  METHOD test_sy.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get_by_sy( ).
  ...
  METHOD test_bapiret.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( lt_msg[ 1 ] ).
  ...
  METHOD test_bapirettab.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( lt_msg ).
  ...
  METHOD test_cx.
    ...
    TRY.
      ...
      CATCH cx_root INTO DATA(lx).
        DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( lx ).
    ENDTRY.
  ...
  METHOD test_get_text_cx.
    ...
    TRY.
        DATA(lv_val) = 1 / 0.
      CATCH cx_root INTO DATA(lx).
        DATA(lv_text) = zabaputil_cl_util_msg=>msg_get_text( lx ).
    ENDTRY.
  ...
  METHOD test_get_text_str.
    ...
    DATA(lv_text) = zabaputil_cl_util_msg=>msg_get_text( `Hello World` ).
  ...
  METHOD test_rap_via_get.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( <failed> ).
    ...
    DATA(lv_text) = zabaputil_cl_util_msg=>msg_get_text( <failed> ).
    cl_abap_unit_assert=>assert_not_initial( lv_text ).
  ...
  METHOD test_collect.
    ...
    DATA(lv_collected) = zabaputil_cl_util_msg=>msg_get_collect( lt_msg ).
  ...
  METHOD test_collect_empty.
    ...
    DATA(lv_collected) = zabaputil_cl_util_msg=>msg_get_collect( lt_empty ).
  ...
  METHOD test_rap_other.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( <reported> ).
  ...
  METHOD test_fallback.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( val = lt_empty val2 = lt_full ).
  ...
  METHOD test_fallback_skip.
    ...
    DATA(lt_result) = zabaputil_cl_util_msg=>msg_get( val = lt_first val2 = lt_second ).
