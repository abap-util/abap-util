...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_factory.
    ...
    DATA(lo_view) = zabaputil_cl_util_xml=>factory( )->__( `View` ).
  ...
  METHOD test_factory_popup.
    ...
    DATA(lo_popup) = zabaputil_cl_util_xml=>factory( )->__( n = `FragmentDefinition` ns = `core`
  ...
  METHOD test_shell_page.
    ...
    DATA(lv_xml) = zabaputil_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
      )->__( `Shell`
      )->__( n = `Page`
  ...
  METHOD test_leaf.
    ...
    DATA(lo_page) = zabaputil_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
      )->__( n = `Page` a = `title` v = `Test` ).
  ...
  METHOD test_nav_up.
    ...
    DATA(lo_root) = zabaputil_cl_util_xml=>factory( ).
  ...
  METHOD test_simple_form.
    ...
    DATA(lo_form) = zabaputil_cl_util_xml=>factory(
      )->__( n = `View` ns = `mvc`
