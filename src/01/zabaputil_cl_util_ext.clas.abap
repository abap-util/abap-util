CLASS zabaputil_cl_util_ext DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS zabaputil_cl_util_ext IMPLEMENTATION.
...
* fallback to RTTI, KEY field does not exist in S/4 2020
    ...
    lt_comp  =  zabaputil_cl_util=>rtti_get_t_attri_by_any( tabname ).
    ...
    LOOP AT lt_comp REFERENCE INTO lr_comp.
      ...
      DATA temp4 TYPE zabaputil_cl_util_ext=>ty_s_dfies.
      CLEAR temp4.
...
*        DATA(ls_row) = CORRESPONDING #( <shlp2>[ 1 ] OPTIONAL ).
    ...
    LOOP AT ms_shlp-interface INTO interface.
      ...
      IF interface-value IS NOT INITIAL.
        ...
        DATA temp6 TYPE zabaputil_cl_util_ext=>ty_shlp_descr-selopt.
        CLEAR temp6.
        temp6 = ms_shlp-selopt.
        DATA temp7 LIKE LINE OF temp6.
        temp7-shlpfield = interface-shlpfield.
        temp7-shlpname = interface-valtabname.
        DATA temp1 TYPE zabaputil_cl_util_ext=>ty_ddshselopt-option.
    ...
    LOOP AT ms_shlp-fieldprop INTO fieldrop.
      ...
      DATA temp8 TYPE zabaputil_cl_util_ext=>ty_shlp_descr-selopt.
      CLEAR temp8.
      temp8 = ms_shlp-selopt.
      DATA temp9 LIKE LINE OF temp8.
      temp9-shlpfield = fieldrop-fieldname.
      DATA temp2 TYPE zabaputil_cl_util_ext=>ty_ddshselopt-option.
    ...
    LOOP AT ms_shlp-fieldprop INTO field_props WHERE shlplispos IS NOT INITIAL.
      ...
      DATA temp10 TYPE zabaputil_cl_util_ext=>ty_s_dfies_2.
      CLEAR temp10.
      DATA temp11 TYPE zabaputil_cl_util_ext=>ty_s_dfies_2.
...
*    set_row_id( ).
  ...
  METHOD _set_e071k.
    ...
    t_comp = zabaputil_cl_util=>rtti_get_t_attri_by_table_name( 'E071K' ).
    ...
    DATA dfies TYPE zabaputil_cl_util_ext=>ty_t_dfies.
...
*    ENDIF.
  ...
  METHOD _set_e071.
    ...
    DATA t_comp TYPE abap_component_tab.
    t_comp = zabaputil_cl_util=>rtti_get_t_attri_by_table_name( 'E071' ).
  ...
  METHOD _read_e070.
    ...
    TRY.
        DATA t_comp TYPE abap_component_tab.
        t_comp = zabaputil_cl_util=>rtti_get_t_attri_by_table_name( table_name ).
    ...
    ELSE.
      ...
      LOOP AT <table> INTO <line>.
        ...
        ELSE.
          ...
          DATA data TYPE REF TO zabaputil_cl_util_ext=>ty_s_transport.
