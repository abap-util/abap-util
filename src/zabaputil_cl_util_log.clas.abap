...
CLASS zabaputil_cl_util_log IMPLEMENTATION.
  ...
  METHOD info.
    ...
    DATA temp15 TYPE zabaputil_cl_util=>ty_s_msg.
    CLEAR temp15.
    temp15-type = `I`.
    temp15-text = val.
  ...
  METHOD error.
    ...
    DATA temp16 TYPE zabaputil_cl_util=>ty_s_msg.
    CLEAR temp16.
    temp16-type = `E`.
    temp16-text = val.
  ...
  METHOD warning.
    ...
    DATA temp17 TYPE zabaputil_cl_util=>ty_s_msg.
    CLEAR temp17.
    temp17-type = `W`.
    temp17-text = val.
  ...
  METHOD success.
    ...
    DATA temp18 TYPE zabaputil_cl_util=>ty_s_msg.
    CLEAR temp18.
    temp18-type = `S`.
    temp18-text = val.
