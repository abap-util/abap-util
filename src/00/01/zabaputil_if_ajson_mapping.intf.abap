INTERFACE zabaputil_if_ajson_mapping
  PUBLIC.
  ...
  TYPES:
    ty_table_of TYPE STANDARD TABLE OF REF TO zabaputil_if_ajson_mapping.
  ...
  METHODS rename_node
    ...
    CHANGING
      !cv_name TYPE zabaputil_if_ajson_types=>ty_node-name.
