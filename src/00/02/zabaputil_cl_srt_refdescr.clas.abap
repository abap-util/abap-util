...
CLASS zabaputil_cl_srt_refdescr DEFINITION
  PUBLIC
  INHERITING FROM zabaputil_cl_srt_datadescr
  CREATE PUBLIC.

  PUBLIC SECTION.

    DATA referenced_type TYPE REF TO zabaputil_cl_srt_typedescr.
...
CLASS zabaputil_cl_srt_refdescr IMPLEMENTATION.
  METHOD constructor.
    super->constructor( rtti ).
    CREATE OBJECT referenced_type TYPE zabaputil_cl_srt_typedescr
