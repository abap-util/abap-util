CLASS ltcl_test DEFINITION FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS keep_node
      IMPORTING
        iv_type         TYPE zabaputil_if_ajson_types=>ty_node_type OPTIONAL
        iv_value        TYPE string                             OPTIONAL
        iv_children     TYPE i                                  OPTIONAL
        iv_visit        TYPE zabaputil_if_ajson_filter=>ty_visit_type DEFAULT zabaputil_if_ajson_filter=>visit_type-value
      RETURNING
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_keeps_filled_string.
    ...
    cl_abap_unit_assert=>assert_true( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-string
                                                 iv_value = `abc` ) ).
  ...
  METHOD test_drops_empty_string.
    ...
    cl_abap_unit_assert=>assert_false( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-string
                                                  iv_value = `` ) ).
  ...
  METHOD test_keeps_number.
    ...
    cl_abap_unit_assert=>assert_true( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-number
                                                 iv_value = `42` ) ).
  ...
  METHOD test_drops_zero.
    ...
    cl_abap_unit_assert=>assert_false( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-number
                                                  iv_value = `0` ) ).
  ...
  METHOD test_keeps_true.
    ...
    cl_abap_unit_assert=>assert_true( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-boolean
                                                 iv_value = `true` ) ).
  ...
  METHOD test_drops_false.
    ...
    cl_abap_unit_assert=>assert_false( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-boolean
                                                  iv_value = `false` ) ).
  ...
  METHOD test_keeps_filled_object.
    ...
    cl_abap_unit_assert=>assert_true( keep_node( iv_children = 3
                                                 iv_visit    = zabaputil_if_ajson_filter=>visit_type-close ) ).
  ...
  METHOD test_keeps_on_open_visit.
    ...
    cl_abap_unit_assert=>assert_true( keep_node( iv_type  = zabaputil_if_ajson_types=>node_type-string
                                                 iv_value = ``
                                                 iv_visit = zabaputil_if_ajson_filter=>visit_type-open ) ).
