...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_uuid_get_c32.
    ...
    DATA(lv_uuid) = zabaputil_cl_util_api=>uuid_get_c32( ).
  ...
  METHOD test_uuid_get_c22.
    ...
    DATA(lv_uuid) = zabaputil_cl_util_api=>uuid_get_c22( ).
    cl_abap_unit_assert=>assert_not_initial( lv_uuid ).
  ...
  METHOD test_context_check_abap_cloud.
    ...
    DATA(lv_result) = zabaputil_cl_util_api=>context_check_abap_cloud( ).
  ...
  METHOD test_context_get_user_tech.
    ...
    TRY.
        lv_user_tech = zabaputil_cl_util_api=>context_get_user_tech( ).
  ...
  METHOD test_context_get_sy.
    ...
    DATA(ls_sy) = zabaputil_cl_util_api=>context_get_sy( ).
  ...
  METHOD test_context_get_tenant.
    ...
    DATA(lv_tenant) = zabaputil_cl_util_api=>context_get_tenant( ) ##NEEDED.
  ...
  METHOD test_context_get_callstack.
    ...
    DATA(lt_stack) = zabaputil_cl_util_api=>context_get_callstack( ) ##NEEDED.

  ENDMETHOD.

  METHOD test_conv_get_xstring_by_str.

    DATA(lv_xstring) = zabaputil_cl_util_api=>conv_get_xstring_by_string( `test` ).
  ...
  METHOD test_conv_get_string_by_xstr.
    ...
    DATA(lv_xstring) = zabaputil_cl_util_api=>conv_get_xstring_by_string( `hello` ).
    DATA(lv_string) = zabaputil_cl_util_api=>conv_get_string_by_xstring( lv_xstring ).
  ...
  METHOD test_conv_encode_x_base64.
    ...
    DATA(lv_xstring) = zabaputil_cl_util_api=>conv_get_xstring_by_string( `base64 test` ).
    DATA(lv_base64) = zabaputil_cl_util_api=>conv_encode_x_base64( lv_xstring ).
  ...
  METHOD test_conv_decode_x_base64.
    ...
    DATA(lv_xstring) = zabaputil_cl_util_api=>conv_get_xstring_by_string( `decode test` ).
    DATA(lv_base64) = zabaputil_cl_util_api=>conv_encode_x_base64( lv_xstring ).
    DATA(lv_decoded) = zabaputil_cl_util_api=>conv_decode_x_base64( lv_base64 ).
  ...
  METHOD test_encoding_roundtrip.
    ...
    DATA(lv_xstring)  = zabaputil_cl_util_api=>conv_get_xstring_by_string( lv_string ).
    DATA(lv_string2)  = zabaputil_cl_util_api=>conv_encode_x_base64( lv_xstring ).
    DATA(lv_xstring2) = zabaputil_cl_util_api=>conv_decode_x_base64( lv_string2 ).
    DATA(lv_string3)  = zabaputil_cl_util_api=>conv_get_string_by_xstring( lv_xstring2 ).
  ...
  METHOD test_conv_get_xlsx_by_itab.
    ...
    DATA(lv_result) = zabaputil_cl_util_api=>conv_get_xlsx_by_itab( lt_tab ) ##NEEDED.
  ...
  METHOD test_conv_get_itab_by_xlsx.
    ...
    zabaputil_cl_util_api=>conv_get_itab_by_xlsx( EXPORTING val    = lv_xstring
  ...
  METHOD test_rtti_get_data_elem_texts.
    ...
    DATA(ls_result) = zabaputil_cl_util_api=>rtti_get_data_element_texts( `UNAME` ).
    IF zabaputil_cl_util_api=>context_check_abap_cloud( ) = abap_false.
  ...
  METHOD test_rtti_get_classes_impl.
    ...
    DATA(mt_classes) = zabaputil_cl_util_api=>rtti_get_classes_impl_intf( `IF_SERIALIZABLE_OBJECT` ).
  ...
  METHOD test_rtti_get_t_fixvalues.
    ...
    IF zabaputil_cl_util_api=>context_check_abap_cloud( ).
      RETURN.
    ENDIF.
    ...
    DATA(lt_result) = zabaputil_cl_util_api=>rtti_get_t_fixvalues( elemdescr = lo_elem
  ...
  METHOD test_rtti_get_table_desrc.
    ...
    DATA(lv_result) = zabaputil_cl_util_api=>rtti_get_table_desrc( tabname = `T100` ).
  ...
  METHOD test_source_get_method.
    ...
    DATA(lt_source) = zabaputil_cl_util_api=>source_get_method(
  ...
  METHOD test_bal_read.
    ...
    DATA(lt_result) = zabaputil_cl_util_api=>bal_read( object    = `TEST`
                                                    subobject = `TEST`
                                                    id        = `TEST` ) ##NEEDED.
  ...
  METHOD test_bal_create.
    ...
    DATA lt_log TYPE zabaputil_cl_util=>ty_t_msg.
    zabaputil_cl_util_api=>bal_create( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST`
                                   t_log     = lt_log ).
  ...
  METHOD test_bal_update.
    ...
    DATA lt_log TYPE zabaputil_cl_util=>ty_t_msg.
    zabaputil_cl_util_api=>bal_update( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST`
                                   t_log     = lt_log ).
  ...
  METHOD test_bal_delete.
    ...
    zabaputil_cl_util_api=>bal_delete( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST` ).
