...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_sql_get_by_string.
    ...
    DATA(lv_test) = ``.
    DATA(ls_sql) = zabaputil_cl_util=>filter_get_sql_by_sql_string( lv_test ) ##NEEDED.

  ENDMETHOD.

  METHOD test_create.

    DATA(lo_test) = NEW zabaputil_cl_util( ) ##NEEDED.
  ...
  METHOD test_rtti_get_classname_by_ref.
    ...
    DATA(lv_name2) = zabaputil_cl_util=>rtti_get_classname_by_ref( lo_test2 ).
...
*    GET REFERENCE OF lv_test INTO lr_data.
    ...
    DATA(lr_test2) = zabaputil_cl_util=>conv_copy_ref_data( lr_data ).
  ...
  METHOD test_time_get_timestampl.
    ...
    DATA(lv_time) = zabaputil_cl_util=>time_get_timestampl( ).

    DATA(lv_time2) = zabaputil_cl_util=>time_substract_seconds( time    = lv_time
                                                            seconds = 60 * 60 * 4 ).
  ...
  METHOD test_time_substract_seconds.
    ...
    DATA(lv_time) = zabaputil_cl_util=>time_get_timestampl( ).
    DATA(lv_time2) = zabaputil_cl_util=>time_get_timestampl( ).
  ...
  METHOD test_x_check_raise.
    ...
    TRY.
        zabaputil_cl_util=>x_check_raise( xsdbool( 1 = 1 ) ).
        cl_abap_unit_assert=>fail( ).
      CATCH cx_root ##NO_HANDLER.
    ENDTRY.

    TRY.
        zabaputil_cl_util=>x_check_raise( xsdbool( 1 = 3 ) ).
      CATCH cx_root.
        cl_abap_unit_assert=>fail( ).
    ENDTRY.
  ...
  METHOD test_url_param_create_url.
    ...
    DATA(lt_param) = zabaputil_cl_util=>url_param_get_tab(
                         `https://url.com/rvice_for_ui?sap-client=100&app_start=z2ui5_cl_app_hello_world` ).
    DATA(lv_url) = zabaputil_cl_util=>url_param_create_url( lt_param ).
  ...
  METHOD test_url_param_get.
    ...
    DATA(lv_param) = zabaputil_cl_util=>url_param_get(
                         val = `app_start`
  ...
  METHOD test_url_param_set.
    ...
    DATA(lv_param) = zabaputil_cl_util=>url_param_set(
                         name  = `app_start`
  ...
  METHOD test_x_check_raise_not.
    ...
    TRY.
        zabaputil_cl_util=>x_check_raise( xsdbool( 1 = 2 ) ).
  ...
  METHOD test_rtti_get_type_name.
    ...
    DATA(lv_name) = zabaputil_cl_util=>rtti_get_type_name( lv_xsdbool ).
  ...
  METHOD test_rtti_get_type_kind.
    ...
    DATA(lv_type_kind) = zabaputil_cl_util=>rtti_get_type_kind( lv_string ).
  ...
  METHOD test_rtti_get_t_attri_by_obj.
    ...
    DATA(lt_attri) = zabaputil_cl_util=>rtti_get_t_attri_by_oref( lo_obj ).
  ...
  METHOD test_rtti_get_t_comp_by_struc.
    ...
    DATA(lt_comp) = zabaputil_cl_util=>rtti_get_t_attri_by_any( ls_row ).
  ...
  METHOD test_trans_xml_any_2__w_obj.
    ...
    DATA(lo_obj) = NEW ltcl_test_app( ).
    DATA(lv_xml) = zabaputil_cl_util=>xml_stringify( lo_obj ).
  ...
  METHOD test_trans_xml_any_2__w_data.
    ...
    DATA(lv_xml) = zabaputil_cl_util=>xml_stringify( ls_row ).
  ...
  METHOD test_rtti_get_t_attri_by_incl.
    ...
    IF zabaputil_cl_util=>context_check_abap_cloud( ).
      RETURN.
    ENDIF.
    DATA(lt_attri) = zabaputil_cl_util=>rtti_get_t_attri_by_include( CAST #( lo_datadescr ) ).
...
CLASS ltcl_unit_test_strings IMPLEMENTATION.
  ...
  METHOD test_c_split.
    ...
    DATA(lt_result) = zabaputil_cl_util=>c_split( val = `one;two;three`
                                               sep = `;` ).
  ...
  METHOD test_c_split_single.
    ...
    DATA(lt_result) = zabaputil_cl_util=>c_split( val = `nosep`
                                               sep = `;` ).
  ...
  METHOD test_c_join.
    ...
    DATA(lv_result) = zabaputil_cl_util=>c_join( lt_tab ).
  ...
  METHOD test_c_join_with_sep.
    ...
    DATA(lt_tab) = VALUE string_table( ( `one` ) ( `two` ) ( `three` ) ).
    DATA(lv_result) = zabaputil_cl_util=>c_join( tab = lt_tab
                                              sep = `-` ).
...
CLASS ltcl_unit_test_rtti IMPLEMENTATION.
  ...
  METHOD test_rtti_tab_rel_name.
    ...
    DATA(lv_name) = zabaputil_cl_util=>rtti_tab_get_relative_name( lt_tab ).
...
CLASS ltcl_unit_test_filter IMPLEMENTATION.
  ...
  METHOD test_range_by_token_le.
    ...
    DATA(ls_range) = zabaputil_cl_util=>filter_get_range_by_token( `<=200` ).
  ...
  METHOD test_range_by_token_ge.
    ...
    DATA(ls_range) = zabaputil_cl_util=>filter_get_range_by_token( `>=75` ).
  ...
  METHOD test_range_by_token_bt.
    ...
    DATA(ls_range) = zabaputil_cl_util=>filter_get_range_by_token( `100...500` ).
  ...
  METHOD test_token_range_mapping.
    ...
    DATA(lt_mapping) = zabaputil_cl_util=>filter_get_token_range_mapping( ).
  ...
  METHOD test_range_t_by_token_t.
    ...
    DATA(lt_tokens) = VALUE zabaputil_cl_util=>ty_t_token(
      ( key = `=100` text = `=100` visible = abap_true editable = abap_true )
      ( key = `>50`  text = `>50`  visible = abap_true editable = abap_true ) ).

    DATA(lt_range) = zabaputil_cl_util=>filter_get_range_t_by_token_t( lt_tokens ).
  ...
  METHOD test_filter_get_multi.
    ...
    DATA(ls_row) = VALUE ty_row( ).
    DATA(lt_filter) = zabaputil_cl_util=>filter_get_multi_by_data( ls_row ).
  ...
  METHOD test_filter_get_data.
    ...
    DATA(lt_result) = zabaputil_cl_util=>filter_get_data_by_multi( lt_filter ).
...
CLASS ltcl_unit_test_conversion IMPLEMENTATION.
  ...
  METHOD test_json_roundtrip.
    ...
    DATA(lv_json) = zabaputil_cl_util=>json_stringify( ls_in ).
  ...
  METHOD test_csv_roundtrip.
    ...
    DATA(lv_csv) = zabaputil_cl_util=>itab_get_csv_by_itab( lt_in ).
  ...
  METHOD test_conv_string_to_date.
    ...
    DATA(lv_date) = zabaputil_cl_util=>conv_string_to_date( `2024-03-15` ).
  ...
  METHOD test_conv_date_to_string.
    ...
    DATA(lv_str) = zabaputil_cl_util=>conv_date_to_string( CONV d( `20240315` ) ).
  ...
  METHOD test_conv_date_roundtrip.
    ...
    DATA(lv_date) = zabaputil_cl_util=>conv_string_to_date( lv_original ).
    DATA(lv_back) = zabaputil_cl_util=>conv_date_to_string( lv_date ).
  ...
  METHOD test_itab_get_by_struc.
    ...
    DATA(lt_nv) = zabaputil_cl_util=>itab_get_by_struc( ls_struc ).
  ...
  METHOD test_time_add_seconds.
    ...
    DATA(lv_time) = zabaputil_cl_util=>time_get_timestampl( ).
    DATA(lv_later) = zabaputil_cl_util=>time_add_seconds( time    = lv_time
                                                       seconds = 3600 ).
  ...
  METHOD test_time_diff_seconds.
    ...
    DATA(lv_diff) = zabaputil_cl_util=>time_diff_seconds( time_from = lv_time
                                                       time_to   = lv_later ).
