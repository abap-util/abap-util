...
*    GET REFERENCE OF lv_test INTO lr_data.
  ...
  METHOD test_get_token_t_by_r_t.
    ...
    DATA temp37 TYPE zabaputil_cl_util=>ty_t_range.
    DATA temp38 LIKE LINE OF temp37.
    DATA lt_range LIKE temp37.
    DATA lt_result TYPE zabaputil_cl_util=>ty_t_token.
    DATA temp39 TYPE zabaputil_cl_util=>ty_t_token.
...
DATA BEGIN OF ms_struc2.INCLUDE TYPE ty_struc.INCLUDE TYPE ty_struc_incl.DATA END OF ms_struc2.
    ...
    lt_attri = zabaputil_cl_util=>rtti_get_t_attri_by_include( temp41 ).
...
CLASS ltcl_unit_test_filter IMPLEMENTATION.
  ...
  METHOD test_range_t_by_token_t.
    ...
    DATA temp62 TYPE zabaputil_cl_util=>ty_t_token.
  ...
  METHOD test_filter_get_data.
    ...
    DATA temp73 TYPE zabaputil_cl_util=>ty_t_range.
    DATA temp74 LIKE LINE OF temp73.
    DATA temp75 TYPE zabaputil_cl_util=>ty_t_token.
...
DATA lt_in TYPE temp3.
  ...
  METHOD test_conv_date_to_string.
    ...
    lv_str = zabaputil_cl_util=>conv_date_to_string( temp80 ).
