CLASS zabaputil_cl_util_api_c DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS context_get_callstack
      RETURNING
        VALUE(result) TYPE zabaputil_cl_util=>ty_t_stack.
    ...
    CLASS-METHODS rtti_get_data_element_texts
      IMPORTING
        val           TYPE clike
      RETURNING
        VALUE(result) TYPE zabaputil_cl_util=>ty_s_data_element_text.
    ...
    CLASS-METHODS rtti_get_classes_impl_intf
      IMPORTING
        val           TYPE clike
      RETURNING
        VALUE(result) TYPE zabaputil_cl_util=>ty_t_classes.
    ...
    CLASS-METHODS rtti_get_t_fixvalues
      IMPORTING
        ...
        langu         TYPE clike
      RETURNING
        VALUE(result) TYPE zabaputil_cl_util=>ty_t_fix_val.
...
CLASS zabaputil_cl_util_api_c IMPLEMENTATION.
  ...
  METHOD rtti_get_classes_impl_intf.
    ...
    DATA xco_cp_abap         TYPE c LENGTH 11.
    DATA temp3               TYPE zabaputil_cl_util_api=>ty_t_classes.
    ...
    DATA temp6 TYPE zabaputil_cl_util_api=>ty_s_class_descr.
